        ...
        <div className="flex flex-col lg:flex-row items-start relative">
          <div className="flex flex-col gap-4 lg:max-w-[50%]">
            ...
            <div className="flex flex-wrap gap-4 justify-between">
              <PrimaryButton size="large">Знайти фахівця</PrimaryButton>
              <SecondaryButton size="large">Розмістити замовлення</SecondaryButton>
            </div>
          </div>
      ...
      <Section>
        <div className="flex flex-col gap-12 items-center text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
            <SubjectCard title="Математика" link="#" code="Mat">
              <Icons icon="Mat" size={100} />
            </SubjectCard>
            <SubjectCard title="Українська мова" link="#" code="Ukr">
              <Icons icon="Ukr" size={100} />
            </SubjectCard>
            <SubjectCard title="Англійська мова" link="#" code="Eng">
              <Icons icon="Eng" size={100} />
            </SubjectCard>
            <SubjectCard title="Біологія" link="#" code="Bio">
              <Icons icon="Bio" size={100} />
            </SubjectCard>
            <SubjectCard title="Географія" link="#" code="Geo">
              <Icons icon="Geo" size={100} />
            </SubjectCard>
            <SubjectCard title="Фізика" link="#" code="Phy">
              <Icons icon="Phy" size={100} />
            </SubjectCard>
            <SubjectCard title="Хімія" link="#" code="Che">
              <Icons icon="Che" size={100} />
            </SubjectCard>
            <SubjectCard title="Історія" link="#" code="His">
              <Icons icon="His" size={100} />
            </SubjectCard>
            <SubjectCard title="Інформатика" link="#" code="Inf">
